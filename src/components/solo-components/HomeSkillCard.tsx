    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-5 gap-6">
            {skills.map((skill, index) => (
                <motion.div
                    key={skill.id}
                    className="relative bg-zinc-900/50 rounded-sm flex justify-center items-center gap-3 flex-col p-6 hover:shadow-[0_0_10px_2px_rgba(139,92,246,0.7)] shadow-xl transition duration-900 "
